    ...
    <>
      <section id='about' className='mb-10 py-24 px-10'>
        <div className='flex justify-center mb-14'>
          <h2 className='text-center text-4xl md:text-5xl font-bold text-gray-700 mb-5'>SOBRE MÍ</h2>
        </div>
        <div className='grid grid-cols-1 items-center h-auto gap-10 lg:my-0 md:grid-cols-2 place-items-center'>
          ...
          <img src='/public/profile_BW.jpeg' alt='profile' loading='lazy' className='rounded-3xl border-logo border-4' width={350} />
        </div>
      </section>
    </>
  )
